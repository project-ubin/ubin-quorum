...
module.exports = (done) => {
  ...
  PaymentAgent.deployed().then((instance) => {
    ...
    return paymentAgent.submitPmt(txRef, sender, receiver, amount, express, directQueue, saltInt,
          {
              gas: 1000000,
    ...
    return sgdz.submitShieldedPayment(txRef, receiver_acc, amountHash, gridlocked);
  }).then((result) => {
    ...
    if (directQueue || gridlocked){
      ...
      return paymentAgent.addToGlobalQueue(txRef,
