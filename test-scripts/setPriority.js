...
module.exports = (done) => {
  ...
  PaymentAgent.deployed().then((instance) => {
    ...
    return paymentAgent.payments.call(txRef);
      ...
      console.log("updating priority of "+txRef+" to " + priority + "...");
      return paymentAgent.updatePriority(txRef, priority, {privateFor: keysPrivateFor});    
  }).then((result) => {
